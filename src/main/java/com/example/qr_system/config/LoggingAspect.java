...
public class LoggingAspect {
    ...
    @AfterThrowing(pointcut = "within(@org.springframework.web.bind.annotation.RestController *) || @annotation(com.example.qrsystem.config.LoggingAnnotation)", throwing = "exception")
